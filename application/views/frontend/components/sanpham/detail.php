						...
						<div class="product-view-content">
							...
							<div class="actions-qty">
								...
								<div class="actions-qty__button">
									...
									<buttion class="hotline detail-hotline" aria-label="Hotline" title="Holine: 0942 311 610" onclick="window.location.href='tel:0942311610'"><i class="fa fa-volume-control-phone" aria-hidden="true"></i> 0942 311 610</buttion>
								</div>
							</div>
